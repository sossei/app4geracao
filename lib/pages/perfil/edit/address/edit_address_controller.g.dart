...
part of 'edit_address_controller.dart';
...
mixin _$EditAddressController on _EditAddressControllerBase, Store {
  final _$isRequestingAtom =
      Atom(name: '_EditAddressControllerBase.isRequesting');
  ...
  final _$msgErroAtom = Atom(name: '_EditAddressControllerBase.msgErro');
  ...
  final _$_EditAddressControllerBaseActionController =
      ActionController(name: '_EditAddressControllerBase');

  @override
  dynamic setMsgErro(String msg) {
    final _$actionInfo =
        _$_EditAddressControllerBaseActionController.startAction();
    try {
      return super.setMsgErro(msg);
    } finally {
      _$_EditAddressControllerBaseActionController.endAction(_$actionInfo);
    }
  }
